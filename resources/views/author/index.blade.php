                            ...
                            @foreach($authors as $author)
                                <tr>
                                    ...
                                    <td width="155" class="text-center">
                                        <a href="{{route('author.edit', $author->id)}}" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
                                        <a href="{{route('author.delete', $author->id)}}" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
